...
Write-Host 'git core.hooksPath = .githooks (pre-commit runs format/build/test and requires CHANGELOG with code changes).'
...
Write-Host 'Done. Next: pwsh build/quality.ps1 (runs every gate; see CONTRIBUTING.md).' -ForegroundColor Green
