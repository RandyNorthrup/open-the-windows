...
| `.jscpd.json` | `markdown` not scanned | code fences produce false clones across unrelated docs (seen in CI on Linux); prose duplication is not what the gate guards | never |
